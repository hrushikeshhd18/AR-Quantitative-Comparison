...
class ARCoreRuntimeMaterials extends StatefulWidget {
  @override
  _ARCoreRuntimeMaterialsState createState() => _ARCoreRuntimeMaterialsState();
}

class _ARCoreRuntimeMaterialsState extends State<ARCoreRuntimeMaterials> {
